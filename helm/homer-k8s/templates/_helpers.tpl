...
Common labels
*/}}
{{- define "homer-k8s.labels" -}}
helm.sh/chart: {{ include "homer-k8s.chart" . }}
{{ include "homer-k8s.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "homer-k8s.selectorLabels" -}}
...
*/}}
{{- define "homer-k8s.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "homer-k8s.fullname" .) .Values.serviceAccount.name }}
{{- else }}
