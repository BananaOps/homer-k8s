...
func init() {
	...
	utilruntime.Must(homerbananaopsiov1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "a742f2e4.homer.bananaops.io",
	...
	if err = (&controller.HomerServicesReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "HomerServices")
		os.Exit(1)
	}
